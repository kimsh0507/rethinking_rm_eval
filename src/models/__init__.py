...
from .prm import ProcessRewardModel, MathShepherd, ReasonEval, QwenMathPRM, SkyworkPRM
...
PRM_MODEL_CONFIG = {
    ...
    "Qwen/Qwen2.5-Math-PRM-7B" : {
        "model_class" : QwenMathPRM,
        "prm_type" : "QwenMathPRM",
        "model_type": "prm",
        "tokenizer_name": "Qwen/Qwen2.5-Math-PRM-7B"
    },
    "Skywork/Skywork-o1-Open-PRM-Qwen-2.5-7B" : {
        "model_class" : SkyworkPRM,
        "prm_type" : "Skywork_PRM",
        "model_type": "prm",
        "tokenizer_name": "Skywork/Skywork-o1-Open-PRM-Qwen-2.5-7B"
    }
}